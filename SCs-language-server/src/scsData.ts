...
export const scsDetails = new Map<string, string> ([
    ...
    ["sc_common_arc","Set of all sc-arcs"],
    ["sc_common_edge", "Set of all sc-edges"],
    ["sc_main_arc", "Set of all main arcs"],
    ["sc_membership_arc", "Set of all membership arcs"],
    ...
    ["sc_node_tuple", "Set of all tuples"],
    ["sc_node_structure", "Set of all structures"],
    ["sc_node_role_relation", "Set of all role relations"],
    ["sc_node_non_role_relation", "Set of all non role relations"],
